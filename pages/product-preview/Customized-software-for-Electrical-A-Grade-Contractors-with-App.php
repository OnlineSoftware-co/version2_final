            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Customized software for Electrical A Grade Contractors with App</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/electrical1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/electrical1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/electrical1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/electrical1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>It is an all-in-one Electrical Contractor business management app that helps automate business processes and workflows.</p>
                            <p>Desktop & Online integration, scheduling, dispatch, invoicing, text notifications, payment processing, marketing, online booking, & much more!</p>
                            <ul>
                                <li>Best Ease of use</li>
                                <li>Billing and Invoice software</li>
                                <li>Work order software</li>
