            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Multi-Referral Management Software</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/multireferral1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/multireferral1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/multireferral1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/multireferral1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>This is the multi-referral management software which has catergories such as jobs vacancies, telephone services, cellular phone services. </p>
                            <ul>
                                <li>Jobs and work from home</li>
                        ...
                        <div class="purchase-info">
                            <a href="../enquiry/index.php?product=14" type="button" class="btn p12"><i class="fas fa-envelope"></i> Place Enquiry </a>
                        </div>
