            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Software for Building Materials Management Sales and Payment Collections with App</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/building1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/building1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/building1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/building1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>This software provides advanced point-of-sale and business management solutions for lumberyards, hardware stores, and building materials suppliers.Helps you manage your business and stay productive from anywhere.is available in a browser or mobile app, and allows customers to access their account information, make payments, and place orders online. Both products will make your business more efficient and customer focused.</p>
                   
                            <ul>
                                <li>Easy-to-use, end-to-end solution</li>
                                <li>Superior document management capabilities</li>
                                <li>Mobility solutions improve efficiency</li>
