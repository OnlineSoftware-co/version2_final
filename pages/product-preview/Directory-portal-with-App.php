            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Directory portal with App</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/directory1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/directory1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/directory1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/directory1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p> It will help consumers find all category of lists right from a local Electricians to Business magnets and Motels to Hospitals at their doorstep with no efforts in a user friendly way!! While searching, people use to get annoyed with ads but,

“Out directory list is category specific and so totally free from pop-ups and unwanted ads”

Hence, it makes consumers to get the specific business by comparing their products and services with their profiles. They can read the reviews and also can share their experiences too.</p>
                            <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <ul>
                                <li>User friendly </li>
                                <li>Top level searches</li>
                                <li>For both consumers and businesses</li>
