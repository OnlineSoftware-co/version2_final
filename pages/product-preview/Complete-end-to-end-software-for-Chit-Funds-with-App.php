                ...
                <div class="card">
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>Online Chit Fund is a versatile Web-based ERP Application and Client-Server Application for Chit fund companies.</p>
                            <p> It provides secured online access to its subscribers on information on the next payment, etc., facilitating all essential features required to streamline chit fund activities. Chit Fund Software, not only systemizes all activities but also helps cut down on reports preparation time, enhancing the quality and accuracy of information.</p>
                            
                            <ul>
                                <li>Security Management</li>
                                <li>Alerts and Intimation</li>
                                <li>Customer Management</li>
                                <li>Group Management</li>
                                <li>Customer Notification and Customer Portal</li>
                            </ul>
                        </div>
