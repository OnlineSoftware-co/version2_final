            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Matrimony web portal with App</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/matrimony1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/matrimony1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/matrimony1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/matrimony1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>Helps you to find a right a right match fast & easy. Providing  detailed family and background information to help you to take next step confidentially. Happy to welcome you to the matching network and wish you success every step of the way</p>

                            <ul>
				                <li>User friendly application</li>
                                <li>Register your profile</li>
                                <li>Get the detailed family and background of your searches </li>
                                <li>Find your match</li>
                                <li>Happy marriage......</li>    
                            </ul>
                        </div>
