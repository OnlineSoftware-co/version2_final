            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Nidhi Company Software with App</h2>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>Nidhi company is the NBFC which deals in financial activities and hence the data of the members is highly important, there fore you need a software to manage.
...
If you are really serious about the building a finance business then you must have proper reports from this which our software shall provide.
                            ...
                            <ul>
                                <li>Add unlimited members with automatic share allotment.</li>
                                <li>All nidhi compliances can made from software </li>
                                <li>Automatic return preparation and data reconciliation.</li>
                                <li>Simple installation</li>
                                <li>All Nidhi forms, Interest rates, Interest calculators available</li>
                            </ul>
                        </div>
                        ...
                        <div class="purchase-info">
                            <a href="../enquiry/index.php?product=10" type="button" class="btn p12"><i class="fas fa-envelope"></i> Place Enquiry </a>
                        </div>
