            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Online Job Portal with App</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/job1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/job1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/job1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/job1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>Find jobs, the most comprehensive search engine for jobs.
In a single search, this application offers free access to millions of jobs from thousands of company websites and job boards.
From search to apply, Job Search app helps you through the entire process of finding a new job.</p>

                            <ul>
                                <li>Sign up</li>
                                <li>Make your profile for recuriters</li>
                                <li>Filter from various jobs available</li>
                                <li>Apply for other filters like salary range, part time , full time </li>
                                <li>Find your job</li>
                            </ul>
                        </div>
