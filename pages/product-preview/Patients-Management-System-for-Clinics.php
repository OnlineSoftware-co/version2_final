            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Patients Management System for Clinics</h2>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>Clinic Software is an easy to use, affordable and powerful Software for Doctors to manage clinic at their finger tips. A useful clinic-software for Patient Management, Clinic Management, OPD Management with cloud backup to save your important data. clinic-software that keeps on evolving as the times change.</p>
                            <ul>
                                <li>Patient Mangement</li>
                                <li>Patient Registration, history</li>
