            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Customized software for textile processing units with App</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/textile1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/textile1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/textile1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/textile1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>The most complex procedure that actively includes merchandisers and top management is apparel costing. Keeping all the factors in mind, the type of fabric, trim, garment testing, logistics, and value-addition costs, calculating them manually is a difficult task. This app allows the user to calculate the consumption of fabric, trims and other accessories used in a garment along with the costs involved in its testing and transportation.</p>
                            <ul>
                                <li>Accounting</li>
                                <li>CRM & Sales Dashboards, Reports, Analytics</li>
