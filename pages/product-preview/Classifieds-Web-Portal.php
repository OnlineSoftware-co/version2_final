            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Classifieds Web Portal</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/portal1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/portal1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/portal1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/portal1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>It is a online classified services which provides information on catergories such as jobs, recipes, business directory, news. It will provide registered users the ability to post online advertisements for free. In additon, visitors to the website will be to able view all the information posted under various categories such as For Sale, Cars, Apartments, Housing, Pets, Personals, , and other categories​ </p>
                            <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <ul>
                                <li>Information on various catergories such as jobs, recipes , business.</li>
                                <li>Register for free adds</li>
                                <li>User friendly</li>
                                <li>Polling is available</li>
