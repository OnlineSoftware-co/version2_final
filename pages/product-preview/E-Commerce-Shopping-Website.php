            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">E-Commerce Shopping Website</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/ecommerce1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/ecommerce1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/ecommerce1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/ecommerce1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>It has vast collection and their filtering options, as just having categories is not enough. Intelligent filtering options makes searches quick. There is a wide collection of peripherals. One thing we liked about this site is that it features a deal on each of its category pages. Add to your cart and make a quick payment. </p>
                            <ul>
                                <li>User friendly</li>
                                <li>Filters available</li>
                                <li>Quick payment</li>
                        ...
                        <div class="purchase-info">
                            <a href="../enquiry/index.php?product=12" type="button" class="btn p12"><i class="fas fa-envelope"></i> Place Enquiry </a>
                        </div>
