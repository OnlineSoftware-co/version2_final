            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Hybrid billing software with GST Options</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/hybrid1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/hybrid1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/hybrid1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/hybrid1.png" alt="image">
                            </div>
