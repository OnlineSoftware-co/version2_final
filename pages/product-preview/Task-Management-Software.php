            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Task Management Software</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/task1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/task1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/task1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/task1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            <h2>About : </h2>
                            <p>It’s an organized system for identifying, monitoring, and managing the work you and your team. It has an intuitive calendar to help you see how your events and tasks fit together. This task management solution can also organize tasks and filter your workflow by due date or category. Task management involves:</p>
                            <ul>
                                <li>Manages tasks, resources and accounts of your project</li>
                                <li>Powerful to-do list management</li>
                                <li>Delegating work to team members</li>
                                <li>Setting deadlines</li>
                                <li>Adjusting work schedules</li>
                            </ul>
                        </div>
                        ...
                        <div class="purchase-info">
                            <a href="../enquiry/index.php?product=8" type="button" class="btn p12"><i class="fas fa-envelope"></i> Place Enquiry </a>
                        </div>
