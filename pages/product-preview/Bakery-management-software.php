            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="product-imgs">
                        <h2 class="product-title">Bakery management software</h2>
                        <div class="img-display">
                            <div class="img-showcase">
                                <img class="preview" src="../../assets/images/img/bakery1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/bakery1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/bakery1.png" alt="image">
                                <img class="preview" src="../../assets/images/img/bakery1.png" alt="image">
                            </div>
                    ...
                    <div class="product-content">
                        <div class="product-detail">
                            ...
                            <p>.The Bakery Management System offers the best of the Bakery-built Speedy and Efficient POS system, combined with comfort and versatility. 
                                ...
                                any mobile access makes everyday tasks easier, smoother and quicker for anyone from small independent to large corporate franchise restaurant groups Kitchen KIT 
                            </p>
                            <ul>
                                <li>Control of Receipe, Raw Material</li>
                                <li>Admin & Reports of Multi Store Move</li>
                                <li>POS, Management of Dinning</li>
                                <li>Company Report of Interval</li>
                                <li>Management & Reviews Multi Store Stock Return Obtain</li>
                            </ul>
                        </div>
